...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyDzRbaJKEClGBXtGqp2t-cZkTcYy5Wso_w",
  authDomain:
    import.meta.env.VITE_FIREBASE_AUTH_DOMAIN ||
    "netwin-tournament.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "netwin-tournament",
  storageBucket:
    import.meta.env.VITE_FIREBASE_STORAGE_BUCKET ||
    "netwin-tournament.firebasestorage.app",
  messagingSenderId:
    import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "842283500427",
  appId:
    import.meta.env.VITE_FIREBASE_APP_ID ||
    "1:842283500427:web:f691cb23a243cc77e4258e",
  measurementId: import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || "G-1Y4GHK4HDJ",
};
...
if (isDevelopment && useEmulators) {
  try {
    ...
    console.log(
      "Emulator connection failed, using production Firebase:",
      error,
    );
  }
} else {
